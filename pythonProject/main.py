...
def main(path1,path2):
    save_path = 'D:\\PyCharm\\PyCharm 2022.1.3\\pythonProject\\result.txt'  # 输出结果绝对路径
...
if __name__ == '__main__':
    # path1 = "D:\\PyCharm\\PyCharm 2022.1.3\\pythonProject\\orig.txt"  # 论文原文的文件的绝对路径（作业要求）
    # path2 = "D:\\PyCharm\\PyCharm 2022.1.3\\pythonProject\\orig_0.8_add.txt"  # 抄袭版论文的文件的绝对路径
